...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'mypage.notificationEnabled': 'Enable Notifications',
    'mypage.logout': 'Logout',
    'mypage.logoutConfirm': 'Are you sure you want to logout?',
    'mypage.withdraw': 'Delete Account',
    'mypage.withdrawConfirm': 'Are you sure you want to delete your account? All data will be removed.',
    'mypage.withdrawSuccess': 'Account deleted successfully.',
    'mypage.profileImage': 'Profile Image',
    'mypage.changeProfileImage': 'Change Profile Image',
    'mypage.deleteProfileImage': 'Delete Profile Image',
    'mypage.deleteImageConfirm': 'Are you sure you want to delete your profile image?',
    'mypage.save': 'Save',
    'mypage.cancel': 'Cancel',
    'mypage.delete': 'Delete',
    'mypage.updateSuccess': 'Updated successfully.',
    'mypage.passwordChangeSuccess': 'Password changed successfully.',
    'mypage.nickname': 'Nickname',
    'mypage.permissionRequired': 'Permission Required',
    'mypage.photoLibraryPermission': 'Photo library access permission is required.',
  },
};
